 ...
 * @since 1.0
 */
public class LoadWeiXinFileAction extends AbstractLoadHostCheckingFileAction {
	...
	public void load(Map transData) {
		...
		if("SUCCESS".equals(transData.get("trans_status"))){
			para.put("TransName", "00");
			para.put("HostSeqNo", transData.get("transaction_id"));
			para.put("TransSeqNo", transData.get("out_trade_no"));
			para.put("TransAmount", transData.get("total_fee"));
		}else if("REVOKED".equals(transData.get("trans_status"))){
			para.put("TransName", "02");
			para.put("HostSeqNo", transData.get("transaction_id"));
			para.put("TransSeqNo", transData.get("out_trade_no"));
			para.put("TransAmount", transData.get("refund_fee"));
		}else if("REFUND".equals(transData.get("trans_status"))){
			para.put("TransName", "01");
			para.put("HostSeqNo", transData.get("refund_id"));
			para.put("TransSeqNo", transData.get("out_refund_no"));
			para.put("TransAmount", transData.get("refund_fee"));
		}
