...
public class ALBSAction extends AbstractTwoPhaseAction {
	private String url;
	@Override
	public void execute(Context ctx) throws PeException {
		...
		sendMap.put("Function", "ant.mybank.bkmerchanttrade.pay");
		...
		sendMap.put("AuthCode", ctx.getData("auth_code"));
