 ...
 *
 */
public class PrepareCancleOrderForALAction extends AbstractAction{
...
//		order.setFeeAmount(Constants.ZERO);
		...
		order.setDepartmentId(Constants.WS_MYBANK_DEPARTMENTID);
		...
		DepartmentEntity departmentEntity = (DepartmentEntity) getSqlMap().queryForObject(Constants.QUERY_DEPARTMENT_ENTITY_SQL, "alipay");
