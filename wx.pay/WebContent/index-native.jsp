	...
	<div id="main">
        ...
        <form action="testNative" method="post" >
            <div id="body" style="clear:left">
                ...
                <dl class="content">
					<dt class="hideClass">交易类型：</dt>
					<dd class="hideClass">
						<span class="null-star"></span>
						<input size="30" name="trade_type" value="NATIVE" readonly="readonly" maxlength="8"  placeholder="长度32"/>
						<span></span>
						<span></span>
					</dd>
...
<!-- 					</dd> -->
                   ...
                   <!--  <dt>商户订单号：</dt>
                    ...
                    <dd>
                        <span class="null-star"></span>
                        <input name="cashierId" value="000000293773" maxlength="32" size="30"  placeholder="长度32"/>
                        <span class="null-star">(长度32)*</span>
                        <span></span>
                    </dd>
<!--                     <dt>终端IP：</dt> -->
<!--                     <dd> -->
<!--                         <span class="null-star"></span> -->
<!--                         <input name="spbill_create_ip" value="127.0.0.1" maxlength="16"  placeholder="长度16"/> -->
